# Contributing to cwb (Claude Workspace Builder)
...
```bash
# Clone the repo
git clone https://github.com/VolcanixLLC/claude-workspace-builder.git
...
4. Run `cwb security scan` on any new content files (agents, commands, rules, skills).
...
- Run `cwb security scan` on any new or modified content files before committing.
