...
Before reviewing, read **`Obsidian/code/integration-verification-policy.md`**. Apply these additional checks:
...
For sprint completion reviews, also consult **`Obsidian/code/development-process.md`** and verify that the sprint completion checklist items are satisfied (docs updated, release notes, version bump).
