...
class TestStageStatus:
    ...
    def test_status_shows_current_stage(
    ...
    def test_status_shows_criteria(
        self, runner: CliRunner, tmp_path: Path
    ) -> None:
        vault = tmp_path / "Obsidian"
        vault.mkdir()
...
class TestStagePromote:
    ...
    def test_promote_fails_when_criteria_unmet(
        self, runner: CliRunner, tmp_path: Path
    ) -> None:
        vault = tmp_path / "Obsidian"
        vault.mkdir()
    ...
    def test_promote_succeeds_when_criteria_met(
        self, runner: CliRunner, tmp_path: Path
    ) -> None:
        vault = tmp_path / "Obsidian"
        vault.mkdir()
    ...
    def test_promote_writes_updated_config(
        self, runner: CliRunner, tmp_path: Path
    ) -> None:
        vault = tmp_path / "Obsidian"
        vault.mkdir()
