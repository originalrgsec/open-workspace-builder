#!/usr/bin/env python3
"""
claude-workspace-builder — Bootstrap a Claude Code / Cowork workspace.
...
def vault_file_content(rel_path: str) -> str:
    ...
    generators = {
        ...
        "projects/Volcanix/_index.md": _tier_index("Volcanix"),
        "projects/Incubator/_index.md": _tier_index("Incubator"),
        "projects/Claude/_index.md": _tier_index("Claude"),
