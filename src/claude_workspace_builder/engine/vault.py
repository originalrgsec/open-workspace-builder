...
if TYPE_CHECKING:
    from claude_workspace_builder.config import VaultConfig
...
VAULT_FILES = [
    ...
    "projects/Volcanix/_index.md",
    "projects/Incubator/_index.md",
    "projects/Claude/_index.md",
    "decisions/_index.md",
    "code/_index.md",
    "business/_index.md",
]
...
def _projects_index() -> str:
    return textwrap.dedent("""\
        ...
        - [[projects/Personal/_index|Personal]] — non-commercial projects
        - [[projects/Volcanix/_index|Volcanix]] — commercial projects under Volcanix LLC
        - [[projects/Incubator/_index|Incubator]] — early-stage ideas, entity TBD
        - [[projects/Claude/_index|Claude]] — tooling, evaluations, and automation
...
def vault_file_content(rel_path: str) -> str:
    ...
    generators = {
        ...
        "projects/Volcanix/_index.md": lambda: _tier_index("Volcanix"),
        "projects/Incubator/_index.md": lambda: _tier_index("Incubator"),
        "projects/Claude/_index.md": lambda: _tier_index("Claude"),
