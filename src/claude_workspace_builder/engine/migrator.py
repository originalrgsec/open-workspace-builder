...
from claude_workspace_builder.config import Config, load_config
from claude_workspace_builder.engine.builder import WorkspaceBuilder
from claude_workspace_builder.engine.differ import FileGap, diff_workspace
from claude_workspace_builder.security.scanner import Scanner, ScanVerdict
...
def _write_migration_log(vault_path: Path, action: MigrateAction) -> None:
    """Append an action to the migration log in .cwb/migration-log.jsonl."""
    log_dir = vault_path / ".cwb"
...
def migrate_workspace(
    ...
    *,
    ...
    if content_root is None:
        from claude_workspace_builder.cli import _find_content_root
    ...
    with tempfile.TemporaryDirectory(prefix="cwb-migrate-ref-") as tmp_dir:
